  ...
  return (
    <div>
      ...
      <div className="body">
        ...
        nulla justo, eget luctus tortor. Nulla facilisi. Duis aliquet egestas
        ...
        inceptos himenaeos. Sed molestie augue sit amet leo consequat posuere.
        ...
        sed urna ultricies ac tempor dui sagittis. In condimentum facilisis
        ...
        justo in libero. Vestibulum mollis mauris enim.
      </div>
      <div className="callout">
        Looking at it now, last December. We were built to fall apart. Then fall
        back together.
      </div>
      <div className="body">
        ...
        odio nibh euismod nulla, eget auctor orci nibh vel nisi. Aliquam erat
        volutpat. Mauris vel neque sit amet nunc gravida congue sed sit amet
        purus. Quisque lacus quam, egestas ac tincidunt a, lacinia vel velit.
        Aenean facilisis nulla vitae urna tincidunt. Nam vestibulum, arcu
        sodales feugiat consectetur, nisl orci bibendum elit, eu euismod magna
        sapien ut nibh. Donec semper quam scelerisque tortor. Mauris vel neque
        sit amet nunc gravida congue.
      </div>
    </div>
  );
};
